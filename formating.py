...
putform = '<form method="get" action="put"><input type="text" minlength="20" id="toCount" value="" required name="answer" /><button class="button" type="submit">Speak</button></form>'
